...
document.querySelector('#clear').addEventListener('click', () => { form.reset(); message.textContent = ''; errorStatus.textContent = ''; baseLabel.textContent = '—'; rateList.innerHTML = '<p class="empty">Choose a currency to load the latest rates.</p>'; });
